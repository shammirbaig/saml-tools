...
const SignLogoutRequest = () => {
    ...
    return (
        <div className="content relative ml-12 w-full p-8">
            <h1 className="text-xl font-bold"> Sign SAML Logout Request</h1>
                ...
                <div className="mt-6 flex flex-wrap">
                    ...
                    <div className="flex w-full">
                        ...
                        <div className="w-full pt-4 pb-4 pr-4 lg:w-1/2">
                            <InputBox onChange={(e) => { setPrivateKey(e.target.value) }} title={"Logout Request XML"} width={"100%"} height={"170px"} />
                        </div>
...
export default SignLogoutRequest;