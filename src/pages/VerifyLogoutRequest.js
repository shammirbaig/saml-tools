...
const VerifyLogoutRequest = () => {
    ...
    return (
        <div className="content relative ml-12 mb-10 w-full p-8">
            <h1 className="text-xl font-bold"> Verify SAML Logout Request
            </h1>
            ...
            <form className="w-full" onSubmit={handleSubmit}>
                <div className="mt-6 flex flex-wrap">
                    ...
                    <div className="flex w-full">
                        ...
                        <div className="w-full pt-4 pb-4 pr-4 lg:w-1/2">
                            <InputBox onChange={(e) => { setPrivateKey(e.target.value) }} title={"SAML Logout Request"} width={"100%"} height={"170px"} />
                        </div>
                    ...
                    <div className="flex w-full">
                        ...
                        <div className="w-full pt-4 pb-4 pr-4 lg:w-1/2">
                            <InputBox onChange={(e) => { setPrivateKey(e.target.value) }} title={"Private Key of the target (to decrypt elements)"} width={"100%"} height={"170px"} />
                        </div>
                ...
                <div className="flex w-full">
                    ...
                    <div className="w-full pt-4 pb-4 pr-4 lg:w-1/2">
                        <InputBox onChange={(e) => { setPrivateKey(e.target.value) }} title={"Signature of the SAML Logout Request"} width={"100%"} height={"170px"} />
                    </div>
                    <div className="w-full lg:w-1/2">
                        <div className="">
                            <InputField
...
export default VerifyLogoutRequest;